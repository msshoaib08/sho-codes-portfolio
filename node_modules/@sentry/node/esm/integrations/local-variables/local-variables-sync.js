...
const _localVariablesSyncIntegration = ((
  ...
  function handlePaused(
    ...
    _optionalChain([rateLimiter, 'optionalCall', _15 => _15()]);

    // data.description contains the original error.stack
    const exceptionHash = hashFromStack(stackParser, _optionalChain([data, 'optionalAccess', _16 => _16.description]));
    ...
    for (let i = 0; i < Math.min(callFrames.length, 5); i++) {
      ...
      if (_optionalChain([localScope, 'optionalAccess', _17 => _17.object, 'access', _18 => _18.objectId]) === undefined) {
        add(frames => {
        ...
        add(frames =>
          _optionalChain([session, 'optionalAccess', _19 => _19.getLocalVariables, 'call', _20 => _20(id, vars => {
  ...
  function addLocalVariablesToException(exception) {
    const hash = hashFrames(_optionalChain([exception, 'optionalAccess', _21 => _21.stacktrace, 'optionalAccess', _22 => _22.frames]));
    ...
    const frames = (_optionalChain([exception, 'access', _23 => _23.stacktrace, 'optionalAccess', _24 => _24.frames]) || []).filter(frame => frame.function !== 'new Promise');
  ...
  function addLocalVariablesToEvent(event) {
    for (const exception of _optionalChain([event, 'optionalAccess', _25 => _25.exception, 'optionalAccess', _26 => _26.values]) || []) {
  ...
  return {
    ...
    setupOnce() {
      ...
      const clientOptions = _optionalChain([client, 'optionalAccess', _27 => _27.getOptions, 'call', _28 => _28()]);

      if (session && _optionalChain([clientOptions, 'optionalAccess', _29 => _29.includeLocalVariables])) {
...
export { createCallbackList, localVariablesSyncIntegration };
