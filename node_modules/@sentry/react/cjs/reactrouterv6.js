...
function withSentryReactRouterV6Routing(Routes) {
  ...
  const SentryRoutes = (props) => {
    ...
    return React__namespace.createElement(Routes, { ...props, __self: this, __source: {fileName: _jsxFileName, lineNumber: 278}} );
  };
...
function wrapUseRoutes(origUseRoutes) {
 ...
 = (props) => {
  ...
  return (routes, locationArg) => {
    return React__namespace.createElement(SentryRoutes, { routes: routes, locationArg: locationArg, __self: this, __source: {fileName: _jsxFileName, lineNumber: 335}} );
  };
}
